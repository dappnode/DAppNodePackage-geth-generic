...
handle_network() {
  case "$NETWORK" in
  "holesky") set_network_specific_config "--holesky" ;;
  "lukso")
    ...
    ;;
  "mainnet") set_network_specific_config "--mainnet" ;;
  "sepolia") set_network_specific_config "--sepolia" ;;
  *)
